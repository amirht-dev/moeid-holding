...
const ContentContainer = () => (
  <div className="flex flex-1 max-md:gap-12 flex-col max-md:bg-secondary max-md:rounded-b-[15px] -z-20">
    <div className="relative flex flex-[3] items-center gap-10 max-md:text-center md:rounded-[0px_30px_30px_0] bg-secondary md:ps-14">
      <span className="absolute left-0 top-full max-md:hidden overflow-hidden aspect-square w-[30px] bg-inherit after:bg-base-100 after:absolute after:w-[200%] after:aspect-square after:translate-x-1/2 after:rounded-full" />
    ...
    <div className="flex-[2] rounded-[15px] md:px-[30px] grid place-items-center text-base-content/50 leading-relaxed  max-md:max-w-[70%] mx-auto max-md:-mb-5 relative">
...
const VideoContainer = () => (
  <div className="flex-1 rounded-t-[15px] md:rounded-[30px_0_30px_30px] bg-secondary p-8 md:p-16">
    <div className="relative aspect-[6/4] w-full rounded-[15px] md:rounded-[30px]">
